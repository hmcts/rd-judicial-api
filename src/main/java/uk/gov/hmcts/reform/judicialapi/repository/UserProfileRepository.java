...
public interface UserProfileRepository extends JpaRepository<UserProfile, String> {
    ...
    @Query(value = "select distinct per "
                   ...
                   + "and ( (:serviceCode is not null and (appt.serviceCode = :serviceCode or "
                   + "auth.serviceCode = :serviceCode)) or :serviceCode is null ) "
                   + "and ( :serviceCode = 'BFA1' or ((:locationCode is not null and appt.epimmsId = :locationCode)"
