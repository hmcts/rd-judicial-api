...
@Setter
@NoArgsConstructor
public class JudicialUserProfileEntityResponse {
    ...
    public JudicialUserProfileEntityResponse(JudicialUserProfile userProfile) {

        getJudicialUserProfileEntityResponse(userProfile);
    }

    public void getJudicialUserProfileEntityResponse(JudicialUserProfile user) {
