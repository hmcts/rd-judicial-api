...
import static uk.gov.hmcts.reform.judicialapi.elinks.util.RefDataElinksConstants.SCHEDULAR_JOB_DETAILS_FETCH_ERROR;
...
public class PublishSidamIdServiceImpl implements PublishSidamIdService {
    ...
    public ResponseEntity<SchedulerJobStatusResponse> publishSidamIdToAsb() {
        ...
        try {
            ...
            throw new ElinksException(HttpStatus.BAD_REQUEST, SCHEDULAR_JOB_DETAILS_FETCH_ERROR, ex.getMessage());
        }
